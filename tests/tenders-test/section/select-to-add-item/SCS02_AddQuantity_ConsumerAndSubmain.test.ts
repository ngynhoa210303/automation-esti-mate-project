...
import { checkCompareTotalSumCMAS } from "../../../../src/locator/section-locator/consumer-mains-and-submains/fill-quantity-and-check-locator";
...
dotenv.config();
test.describe("SCS02: Add Quantity Consumer And Submain", () => {
